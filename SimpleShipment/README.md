...
I want to click a hyperlink on each reference to show a shipment page (as per UI mockup) and be able to edit any shipment field. Any shipment field can be saved, apart from the shipment reference which cannot be changed.
